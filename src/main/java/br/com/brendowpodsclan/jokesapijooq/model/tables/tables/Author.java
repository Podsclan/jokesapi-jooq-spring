...
public class Author extends TableImpl<AuthorRecord> {
    ...
    private static final long serialVersionUID = 1497779242;

    /**
     * The reference instance of <code>libraryjokes.author</code>
     */
    ...
    /**
     * The column <code>libraryjokes.author.AUTHOR_ID</code>.
     */
    public final TableField<AuthorRecord, Integer> AUTHOR_ID = createField("AUTHOR_ID", org.jooq.impl.SQLDataType.INTEGER.nullable(false).identity(true), this, "");

    /**
     * The column <code>libraryjokes.author.AUTHOR_NAME</code>.
     */
    public final TableField<AuthorRecord, String> AUTHOR_NAME = createField("AUTHOR_NAME", org.jooq.impl.SQLDataType.VARCHAR(40), this, "");

    /**
     * Create a <code>libraryjokes.author</code> table reference
     */
    public Author() {
    ...
    /**
     * Create an aliased <code>libraryjokes.author</code> table reference
     */
